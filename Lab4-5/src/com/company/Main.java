...
public class Main {
    ...
    public static void scene1(Student[] studentList) {
        //Студенты 1,3,4 отсутствуют
        ...
        for (int day =0; day < 5; day++) {
            ...
            studentList[attendingStudent1].assignTask(day);
            studentList[attendingStudent1].assignAchievement(day);

            studentList[attendingStudent2].assignAchievement(day);

            studentList[attendingStudent3].assignTask(day);
        }
    ...
    public static void scene2(Student[] studentList) {
        //Студенты 0,2,5 отсутствуют
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        Random r = new Random();
            ...
            { FileOutputStream outputStream1 = new FileOutputStream("D:\\Student1.ser");
                FileOutputStream outputStream2 = new FileOutputStream("D:\\Student2.ser");
                FileOutputStream outputStream3 = new FileOutputStream("D:\\Student3.ser");
