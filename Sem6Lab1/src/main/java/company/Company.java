...
public class Company {
    ...
    public void moveMoney(int idFrom, int idTo, float cash, String message) {
        try {
            ...
            logger.log("Переведено со счёта " + accFrom.getName() + " на счёт " + accTo.getName() + " сумма - " + cash);
    ...
    public void buyToAccount(int expendId, float cash, int quantity, String message, int incomeId) {
        ...
        logger.log("Куплено " + quantity + " товаров за " + cash + "  на " + accFrom.getName() + " со счёта " + accTo.getName());
    }
    ...
    public void sellFromAccont(int expendId, float oldPrice, int marginPercent, int quantity, String message, int incomeId) {
        ...
        logger.log("Продано с " + accFrom.getName() + " на счёт " + accTo.getName() + " " + quantity + " товаров " + "за " + (oldPrice + oldPrice / 100 * marginPercent));
    }
